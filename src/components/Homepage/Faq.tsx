      ...
      <Container>
        ...
        <Accordion type="single" collapsible>
          ...
          <AccordionItem value="item-3">
            <AccordionTrigger className="text-lg hover:no-underline">How can I track my order?</AccordionTrigger>
            <AccordionContent className="text-[16px]">
              Once your order is dispatched, you will receive a tracking number
              via email that allows you to track the status of your shipment.
            </AccordionContent>
          </AccordionItem>

          <AccordionItem value="item-4">
            <AccordionTrigger className="text-lg hover:no-underline">What is your return policy?</AccordionTrigger>
            <AccordionContent className="text-[16px]">
              We accept returns within 30 days of purchase as long as the books
              are in their original condition. Please contact customer service
              for more details.
            </AccordionContent>
          </AccordionItem>
